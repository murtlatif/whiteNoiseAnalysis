...
def get_args():
    ...
    parser.add_argument('-N', '--wn-num-batches', type=int, default=100,
                        help='Number of white noise batches for analysis')
    parser.add_argument('-W', '--wn-batch-size', type=int, default=10000,
    ...
    parser.add_argument('-L', '--large', action='store_true', help='Use the larger CNN model')
